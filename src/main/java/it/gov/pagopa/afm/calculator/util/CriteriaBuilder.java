package src.main.java.it.gov.pagopa.afm.calculator.util;
...
public class CriteriaBuilder {
    ...
    public static Criteria isNull(String param) {
        return Criteria.getInstance(CriteriaType.IS_NULL, param, Collections.emptyList(), Part.IgnoreCaseType.NEVER);
    }
